  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/40 backdrop-blur-lg border-b border-rose-100/30 px-6 py-3">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <Link 
          to="/" 
          className="group flex items-center gap-2 no-underline transition-transform active:scale-95"
        >
          {/* Heart Icon - Now floating without a background box */}
          <svg 
            xmlns="http://www.w3.org/2000/svg" 
            viewBox="0 0 24 24" 
            fill="currentColor" 
            className="w-7 h-7 text-rose-500 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300"
          >
          ...
          {/* Brand Name - Changed from font-black to font-bold */}
